      ...
      <div className="container flex h-20 items-center justify-between px-6">
        <div className="mr-4 hidden md:flex">
          <Link
            ...
            href="/"
          >
            <div className="p-2 bg-gradient-primary rounded-xl shadow-medium group-hover:shadow-strong transition-shadow">
        ...
        <Sheet>
          ...
          <SheetContent
            side="left"
            className="pr-0 w-72 bg-gradient-to-b from-background to-background/95 border-r border-border/50"
          >
            <Link
            ...
            <div className="flex flex-col space-y-2">
              <Link
                href="/"
                className="flex items-center py-3 px-4 rounded-xl hover:bg-gradient-secondary hover:text-secondary-foreground transition-all touch-manipulation shadow-soft hover:shadow-medium font-medium"
              >
                Projects
              </Link>
              <Link
                href="/docs"
                className="flex items-center py-3 px-4 rounded-xl hover:bg-gradient-accent hover:text-accent-foreground transition-all touch-manipulation shadow-soft hover:shadow-medium font-medium text-muted-foreground"
              >
                Docs
              </Link>
            </div>
